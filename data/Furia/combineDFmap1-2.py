...
if __name__ == "__main__":
    directory = "C:\\Users\\Lazaro B\\Documents\\GitHub\\CSGOProject\\data\\Furia"
    file1 = os.path.join(directory, "NATUSVersusFuria16-08-2023bo3-1.csv")
    file2 = os.path.join(directory, "NATUSVersusFuria16-08-2023bo3-2.csv")
    output_file = os.path.join(directory, "NATUSVersusFuria16-08-2023.csv")
