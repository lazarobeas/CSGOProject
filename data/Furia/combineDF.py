...
csv_dir = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\CSGOProject\\data\\Furia'
...
for filename in os.listdir(csv_dir):
    if filename.endswith('.csv'):
        ...
        kscerato_rows = df[df['Nickname'] == 'arT']
...
if kscerato_data:
    ...
    kscerato_df.to_csv('C:\\Users\\Lazaro B\\Documents\\GitHub\\CSGOProject\\data\\Furia\\arT\\arTtotal.csv', index=False)
